...
public class Utils{
	...
	public static boolean isMusicInfoEmpty(){
		if(LocalMusicFragment.musicInfo == null || LocalMusicFragment.musicInfo.size() == 0){
